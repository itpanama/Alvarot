...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function registerTrucker(Request $request)
    {
        ...
        $data['role_id'] = config('app.role.trucker');
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'email' => 'required|string|email|max:255|unique:users|unique:truckers,email',
    ...
    protected function create(array $data)
    {
        ...
        $trucker->email = $user->email;
        $trucker->contact_name = $data['name'];
